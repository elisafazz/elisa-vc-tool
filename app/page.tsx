      ...
      <div className="px-8 mb-8 animate-fade-up" style={{ animationDelay: '0.24s' }}>
        <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
          <div className="p-8">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              Generate Notion-ready database entries from pitch deck text. Paste extracted deck content and get a fully structured entry with all classification fields pre-filled — ready to copy into the deal flow database.
            </p>
